function [psnr] = decodr(maskPath,maskedImagePath,origImagePath,savePath)
%DECODER 
...
encoder('data/im2.png','data/im2.pbm','data/res_im2.png');
decodr('data/im2.pbm','data/res_im2.png','data/im2.png','data/restored_im2.png');